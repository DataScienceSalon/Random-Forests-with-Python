...
`r kfigr::figr(label = "violation_summary", prefix = TRUE, link = TRUE, type="Table")` confirms all `r py$violation_summary$observations` observations are written against one of `r py$violation_summary$unique` violation codes. There are no missing values.
...
Aside from the missing values, there are no other data quality issues with this variable. 
